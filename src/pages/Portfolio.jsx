            ...
            <AnimatePresence>
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  key={project.id}
                  className="bg-white rounded-2xl overflow-hidden shadow-[0_10px_30px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] border border-slate-100 group transition-all duration-500 hover:-translate-y-2 flex flex-col h-full"
                >
